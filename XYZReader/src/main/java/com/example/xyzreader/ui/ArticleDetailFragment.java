...
public class ArticleDetailFragment extends Fragment implements
    ...
    private static final int SHARE_INTENT_CODE = 4013;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = mRootView.findViewById(R.id.progress_container);
...
//        mPhotoContainerView = mRootView.findViewById(R.id.photo_container);
    ...
    private void shareTopic() {
        ...
        startActivityForResult(Intent.createChooser(ShareCompat.IntentBuilder.from(getActivity())
                ...
                .getIntent(), getString(R.string.action_share)), SHARE_INTENT_CODE);
...
//        mDrawInsetsFrameLayout.setInsetBackground(mStatusBarColorDrawable);
    ...
    private void bindViews() {
        ...
        mLayout = mRootView.findViewById(R.id.coordinator);
        ...
        if (mCursor != null) {
            ...
            Picasso.get().load(imageUrl).into(mPhotoView, new Callback() {
                @Override
...
//            bodyView.setText("N/A");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case SHARE_INTENT_CODE:
                if (resultCode == RESULT_CANCELED) {
                    Snackbar.make(mRootView.findViewById(R.id.share_fab),"Share Canceled,Share Again?" , Snackbar.LENGTH_LONG).
                            setAction("Share", v->
                                shareTopic())
                            .show();
                }
